...
namespace App.MVC.Controller.Commands
{
    ...
    /// 初始化controller
    /// </summary>
    public class InitSpawnerCommand : SimpleCommand
    {
    ...
    public class StartSpawnCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.Spawner.StartSpawn();
        }
    }
    ...
    public class StopSpawnCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.Spawner.PauseSpawn();
        }
    }
    ...
    public class CreateTowerCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            GameManager.Instance.sceneManger.Spawner.CreateTowerObject(body.towerData, body.cellWorldPos);
        }
    }
    ...
    public class SellTowerCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.Spawner.SellTower((Vector3)notification.Body);
        }
    }
    ...
    public class SetCollectingFiresCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.Spawner.SetCollectingFires(notification.Body as IMonster);
        }
    }
    ...
    public class CancelCollectingFiresCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ISpawner spawner = GameManager.Instance.sceneManger.Spawner;
            IMonster tar = spawner.GetCollectingFiresTarget();
            // 判断是否是集火目标
