...
namespace App.MVC.Controller.Commands
{
    ...
    public class AcceptLevelDataCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.SetLevelData((LevelData)notification.Body);
            GameManager.Instance.sceneManger.InitGame();
        }
    }
    ...
    /// 初始化游戏
    /// </summary>
    public class InitSceneManagerCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            InitSceneManagerCommandArgs args = notification.Body as InitSceneManagerCommandArgs;

            // 游戏初始化
            GameManager.Instance.SetSceneManager(args?.sceneManger);
        }
    }
    ...
    public class RestartGameCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.RestartGame();
        }
    }
    ...
    public class PauseGameCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.PauseGame();
        }
    }
    ...
    public class GameWinCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.GameWin();
        }
    }
    ...
    public class GameOverCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.GameOver();
        }
    }
    ...
    public class UpdateMoneyCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            GameManager.Instance.sceneManger.UpdateMoney(num);
        }
    }
    ...
    public class TwoSpeedCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            GameManager.Instance.sceneManger.IsSpeedUp = (bool)notification.Body;
        }
    }
    ...
    public class PlayMusicCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            GameManager.Instance.MusicManger.MuteMusic(false);
        }
    }
    ...
    public class PlaySoundCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            if (GameManager.Instance.dataManager.MusicDataManager.SoundOpen)
            {
            ...
            GameManager.Instance.MusicManger.MuteMusic(GameManager.Instance.dataManager.MusicDataManager.MusicOpen);
        }
    }
