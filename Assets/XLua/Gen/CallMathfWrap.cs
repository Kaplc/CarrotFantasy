...
namespace XLua.CSObjectWrap
{
    ...
    public class CallMathfWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CallMathf);
        ...
        {
            return LuaAPI.luaL_error(L, "CallMathf does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    ...
                    float _x = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = CallMathf.Atan2( _y, _x );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _power = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        var gen_ret = CallMathf.Exp( _power );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _f = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        var gen_ret = CallMathf.Floor( _f );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _f = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        var gen_ret = CallMathf.Log10( _f );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _b = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = CallMathf.Max( _a, _b );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _b = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = CallMathf.Min( _a, _b );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _p = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = CallMathf.Pow( _f, _p );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _f = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        var gen_ret = CallMathf.Round( _f );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _max = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = CallMathf.Clamp( _value, _min, _max );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = CallMathf.Lerp( _a, _b, _t );
                        LuaAPI.lua_pushnumber(L, gen_ret);
