...
namespace XLua.CSObjectWrap
{
    ...
    public class AppMVCViewBeginSceneUIBaseControlBasePageFlippingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(App.MVC.View.BeginScene.UI.BaseControl.BasePageFlipping);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new App.MVC.View.BeginScene.UI.BaseControl.BasePageFlipping();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.MVC.View.BeginScene.UI.BaseControl.BasePageFlipping constructor!");
        ...
        static int _m_ToPage(RealStatePtr L)
        {
		    try {
                ...
                App.MVC.View.BeginScene.UI.BaseControl.BasePageFlipping gen_to_be_invoked = (App.MVC.View.BeginScene.UI.BaseControl.BasePageFlipping)translator.FastGetCSObj(L, 1);
