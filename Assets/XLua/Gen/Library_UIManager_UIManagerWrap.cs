...
namespace XLua.CSObjectWrap
{
    ...
    public class LibraryUIManagerUIManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Library.UIManager.UIManager);
        ...
        {
            return LuaAPI.luaL_error(L, "Library.UIManager.UIManager does not have a constructor!");
        }
        ...
        static int _m_Show(RealStatePtr L)
        {
		    try {
                ...
                Library.UIManager.UIManager gen_to_be_invoked = (Library.UIManager.UIManager)translator.FastGetCSObj(L, 1);
            
            
			    int gen_param_count = LuaAPI.lua_gettop(L);
            
                if(gen_param_count == 5&& translator.Assignable<System.Type>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<Library.UIManager.EUILayerType>(L, 4)&& translator.Assignable<UnityEngine.Events.UnityAction>(L, 5)) 
                {
                    System.Type _panelType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    bool _isFade = LuaAPI.lua_toboolean(L, 3);
                    Library.UIManager.EUILayerType _layerType;translator.Get(L, 4, out _layerType);
                ...
                if(gen_param_count == 4&& translator.Assignable<System.Type>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<Library.UIManager.EUILayerType>(L, 4)) 
                {
                    System.Type _panelType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    bool _isFade = LuaAPI.lua_toboolean(L, 3);
                    Library.UIManager.EUILayerType _layerType;translator.Get(L, 4, out _layerType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Library.UIManager.UIManager.Show!");
        ...
        static int _m_LuaCallShow(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<Library.UIManager.EUILayerType>(L, 4)&& translator.Assignable<UnityEngine.Events.UnityAction>(L, 5)) 
                {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<Library.UIManager.EUILayerType>(L, 4)) 
                {
                    string _panelName = LuaAPI.lua_tostring(L, 2);
                    bool _isFade = LuaAPI.lua_toboolean(L, 3);
                    Library.UIManager.EUILayerType _layerType;translator.Get(L, 4, out _layerType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Library.UIManager.UIManager.LuaCallShow!");
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Library.UIManager.UIManager.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
