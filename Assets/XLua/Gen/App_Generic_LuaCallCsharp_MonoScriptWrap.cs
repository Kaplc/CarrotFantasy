...
namespace XLua.CSObjectWrap
{
    ...
    public class AppGenericLuaCallCsharpMonoScriptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(App.Generic.LuaCallCsharp.MonoScript);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new App.Generic.LuaCallCsharp.MonoScript();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.Generic.LuaCallCsharp.MonoScript constructor!");
        ...
        static int _g_get_onEnableAction(RealStatePtr L)
        {
		    try {
                ...
                App.Generic.LuaCallCsharp.MonoScript gen_to_be_invoked = (App.Generic.LuaCallCsharp.MonoScript)translator.FastGetCSObj(L, 1);
