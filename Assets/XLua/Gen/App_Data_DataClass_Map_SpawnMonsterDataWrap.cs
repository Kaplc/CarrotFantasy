...
namespace XLua.CSObjectWrap
{
    ...
    public class AppDataDataClassMapSpawnMonsterDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(App.Data.DataClass.Map.SpawnMonsterData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new App.Data.DataClass.Map.SpawnMonsterData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.Data.DataClass.Map.SpawnMonsterData constructor!");
        ...
        static int _g_get_monsterType(RealStatePtr L)
        {
		    try {
                ...
                App.Data.DataClass.Map.SpawnMonsterData gen_to_be_invoked = (App.Data.DataClass.Map.SpawnMonsterData)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.monsterType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_nextSpawnTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                App.Data.DataClass.Map.SpawnMonsterData gen_to_be_invoked = (App.Data.DataClass.Map.SpawnMonsterData)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.nextSpawnTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_monsterType(RealStatePtr L)
        {
		    try {
                ...
                App.Data.DataClass.Map.SpawnMonsterData gen_to_be_invoked = (App.Data.DataClass.Map.SpawnMonsterData)translator.FastGetCSObj(L, 1);
                App.Static.Enum.EMonsterType gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.monsterType = gen_value;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_nextSpawnTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
