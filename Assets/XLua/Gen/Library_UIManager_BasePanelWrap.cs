...
namespace XLua.CSObjectWrap
{
    ...
    public class LibraryUIManagerBasePanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Library.UIManager.BasePanel);
        ...
        {
            return LuaAPI.luaL_error(L, "Library.UIManager.BasePanel does not have a constructor!");
        }
        ...
        static int _m_Update(RealStatePtr L)
        {
		    try {
                ...
                Library.UIManager.BasePanel gen_to_be_invoked = (Library.UIManager.BasePanel)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Show(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Library.UIManager.BasePanel.Show!");
