...
namespace XLua.CSObjectWrap
{
    ...
    public class AppMVCControllerGameManagerWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new App.MVC.Controller.GameManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.MVC.Controller.GameManager constructor!");
        ...
        static int _s_set_nowLevelData(RealStatePtr L)
        {
		    try {
                ...
                App.MVC.Controller.GameManager gen_to_be_invoked = (App.MVC.Controller.GameManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.nowLevelData = (App.DataClass.Game.Level.LevelData)translator.GetObject(L, 2, typeof(App.DataClass.Game.Level.LevelData));
        ...
        static int _s_set_musicSettingData(RealStatePtr L)
        {
		    try {
                ...
                App.MVC.Controller.GameManager gen_to_be_invoked = (App.MVC.Controller.GameManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.musicSettingData = (App.DataClass.Player.MusicSettingData)translator.GetObject(L, 2, typeof(App.DataClass.Player.MusicSettingData));
        ...
        static int _s_set_map(RealStatePtr L)
        {
		    try {
                ...
                App.MVC.Controller.GameManager gen_to_be_invoked = (App.MVC.Controller.GameManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.map = (App.MVC.View.GameScene.Object.Map.Map)translator.GetObject(L, 2, typeof(App.MVC.View.GameScene.Object.Map.Map));
        ...
        static int _s_set_sdkManager(RealStatePtr L)
        {
		    try {
                ...
                App.MVC.Controller.GameManager gen_to_be_invoked = (App.MVC.Controller.GameManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sdkManager = (App.SDK.SDKManager)translator.GetObject(L, 2, typeof(App.SDK.SDKManager));
