...
namespace XLua.CSObjectWrap
{
    ...
    public class GameFrameworkUIManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameFramework.UIManager);
        ...
        {
            return LuaAPI.luaL_error(L, "GameFramework.UIManager does not have a constructor!");
        }
        ...
        static int _m_Hide(RealStatePtr L)
        {
		    try {
                ...
                GameFramework.UIManager gen_to_be_invoked = (GameFramework.UIManager)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameFramework.UIManager.Hide!");
        ...
        static int _m_Show(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& translator.Assignable<System.Type>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<GameFramework.EUILayerType>(L, 4)&& translator.Assignable<UnityEngine.Events.UnityAction>(L, 5)) 
                {
                    System.Type _panelType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    bool _isFade = LuaAPI.lua_toboolean(L, 3);
                    GameFramework.EUILayerType _layerType;translator.Get(L, 4, out _layerType);
                ...
                if(gen_param_count == 4&& translator.Assignable<System.Type>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<GameFramework.EUILayerType>(L, 4)) 
                {
                    System.Type _panelType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    bool _isFade = LuaAPI.lua_toboolean(L, 3);
                    GameFramework.EUILayerType _layerType;translator.Get(L, 4, out _layerType);
                ...
                if(gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.EUILayerType>(L, 5)&& translator.Assignable<UnityEngine.Events.UnityAction>(L, 6)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                    string _panelName = LuaAPI.lua_tostring(L, 3);
                    bool _isFade = LuaAPI.lua_toboolean(L, 4);
                    GameFramework.EUILayerType _layerType;translator.Get(L, 5, out _layerType);
                ...
                if(gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.EUILayerType>(L, 5)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                    string _panelName = LuaAPI.lua_tostring(L, 3);
                    bool _isFade = LuaAPI.lua_toboolean(L, 4);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameFramework.UIManager.Show!");
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, GameFramework.UIManager.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
