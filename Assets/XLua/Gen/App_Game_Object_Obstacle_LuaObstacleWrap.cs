...
namespace XLua.CSObjectWrap
{
    ...
    public class AppGameObjectObstacleLuaObstacleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(App.Game.Object.Obstacle.LuaObstacle);
			Utils.BeginObjectRegister(type, L, translator, 0, 6, 17, 15);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new App.Game.Object.Obstacle.LuaObstacle();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.Game.Object.Obstacle.LuaObstacle constructor!");
        ...
        static int _m_OnGet(RealStatePtr L)
        {
		    try {
                ...
                App.Game.Object.Obstacle.LuaObstacle gen_to_be_invoked = (App.Game.Object.Obstacle.LuaObstacle)translator.FastGetCSObj(L, 1);
