...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp5(App.Game.Object.Monster.IMonster p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(App.Game.Spawner.ISpawner p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(App.Game.SceneManager.ISceneDataManager p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp10()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public App.Game.SceneManager.ISceneDataManager __Gen_Delegate_Imp11()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public App.Game.Spawner.ISpawner __Gen_Delegate_Imp12()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public App.Data.DataClass.Map.IMapData __Gen_Delegate_Imp13()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<App.Game.Object.Monster.IMonster>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<App.Game.Spawner.ISpawner>))
			{
			    return new UnityEngine.Events.UnityAction<App.Game.Spawner.ISpawner>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<App.Game.SceneManager.ISceneDataManager>))
			{
			    return new UnityEngine.Events.UnityAction<App.Game.SceneManager.ISceneDataManager>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.Vector3>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector3>(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new System.Func<int>(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(System.Func<App.Game.SceneManager.ISceneDataManager>))
			{
			    return new System.Func<App.Game.SceneManager.ISceneDataManager>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(System.Func<App.Game.Spawner.ISpawner>))
			{
			    return new System.Func<App.Game.Spawner.ISpawner>(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(System.Func<App.Data.DataClass.Map.IMapData>))
			{
			    return new System.Func<App.Data.DataClass.Map.IMapData>(__Gen_Delegate_Imp13);
			}
