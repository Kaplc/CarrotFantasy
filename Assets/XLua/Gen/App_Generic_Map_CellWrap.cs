...
namespace XLua.CSObjectWrap
{
    ...
    public class AppGenericMapCellWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(App.Generic.Map.Cell);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<App.Generic.Map.Point>(L, 2))
				{
					App.Generic.Map.Point _point;translator.Get(L, 2, out _point);
					
					var gen_ret = new App.Generic.Map.Cell(_point);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<App.Generic.Map.ObjectPointClass>(L, 2))
				{
					App.Generic.Map.ObjectPointClass _objectPointClass = (App.Generic.Map.ObjectPointClass)translator.GetObject(L, 2, typeof(App.Generic.Map.ObjectPointClass));
					
					var gen_ret = new App.Generic.Map.Cell(_objectPointClass);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<App.Generic.Map.PointClass>(L, 2))
				{
					App.Generic.Map.PointClass _pointClass = (App.Generic.Map.PointClass)translator.GetObject(L, 2, typeof(App.Generic.Map.PointClass));
					
					var gen_ret = new App.Generic.Map.Cell(_pointClass);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to App.Generic.Map.Cell constructor!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
		    try {
                ...
                App.Generic.Map.Cell gen_to_be_invoked = (App.Generic.Map.Cell)translator.FastGetCSObj(L, 1);
