...
namespace XLua.CSObjectWrap
{
    ...
    public class BasePageFlippingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BasePageFlipping);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new BasePageFlipping();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BasePageFlipping constructor!");
        ...
        static int _m_ToPage(RealStatePtr L)
        {
		    try {
                ...
                BasePageFlipping gen_to_be_invoked = (BasePageFlipping)translator.FastGetCSObj(L, 1);
