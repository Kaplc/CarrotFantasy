...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaSpawnerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaSpawner);
			Utils.BeginObjectRegister(type, L, translator, 0, 16, 16, 16);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaSpawner constructor!");
        ...
        static int _s_set_onGetCarrotAction(RealStatePtr L)
        {
		    try {
                ...
                LuaSpawner gen_to_be_invoked = (LuaSpawner)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onGetCarrotAction = translator.GetDelegate<System.Func<App.MVC.View.GameScene.Object.Carrot.Carrot>>(L, 2);
        ...
        static int _s_set_onInitAction(RealStatePtr L)
        {
		    try {
                ...
                LuaSpawner gen_to_be_invoked = (LuaSpawner)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onInitAction = translator.GetDelegate<UnityEngine.Events.UnityAction<App.DataClass.Map.MapData>>(L, 2);
        ...
        static int _s_set_onCreateTowerObjectAction(RealStatePtr L)
        {
		    try {
                ...
                LuaSpawner gen_to_be_invoked = (LuaSpawner)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onCreateTowerObjectAction = translator.GetDelegate<UnityEngine.Events.UnityAction<App.DataClass.Game.Object.TowerData, UnityEngine.Vector3>>(L, 2);
