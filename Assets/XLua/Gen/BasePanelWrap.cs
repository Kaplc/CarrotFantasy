...
namespace XLua.CSObjectWrap
{
    ...
    public class BasePanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(BasePanel);
        ...
        {
            return LuaAPI.luaL_error(L, "BasePanel does not have a constructor!");
        }
        ...
        static int _m_Update(RealStatePtr L)
        {
		    try {
                ...
                BasePanel gen_to_be_invoked = (BasePanel)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Show(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BasePanel.Show!");
